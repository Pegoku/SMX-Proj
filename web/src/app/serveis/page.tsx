...
export const metadata = {
  ...
  description:
    "Serveis de pintura i reformes a Menorca. Pintura interior i exterior, carpinteria, barnissat.",
};
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-[var(--primary)] text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-2xl md:text-3xl font-bold">Serveis</h1>
            ...
            {[
              {
                step: "1",
                title: "Contacte",
                desc: "Explica'ns el teu projecte",
              },
              { step: "2", title: "Visita", desc: "Avaluam les necessitats" },
              {
                step: "3",
                title: "Pressupost",
                desc: "T'enviam pressupost detallat",
              },
      ...
      <section className="py-12 bg-white border-t border-gray-200">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <a href="tel:+34656921314" className="btn-secondary">
              656 92 13 14
            </a>
          </div>
        </div>
