        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-600 mb-4">
              Som una empresa familiar dedicada a la pintura i les reformes a Menorca. 
              Oferim serveis de qualitat amb atenció personalitzada per a cada projecte.
            </p>
            <div className="flex items-center space-x-4 mt-6 p-4 bg-white rounded border border-gray-200">
              ...
              />
              <div>
                <p className="font-semibold text-gray-800">Miquel A. Riudavets Mercadal</p>
